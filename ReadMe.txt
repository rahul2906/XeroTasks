...
Package Structure: The Source files have been divided into 4 packages.
...
To run the Tests,"ToExecuteTests.xml" is used. The parameter browser is used to decide on the browser(FF-FireFox or IE-Internet Explorer)